...
| `heart` | Fréquence cardiaque / danger | `#FF5C7A` | `#F43F5E` |
...
- Le rouge `heart` sert aussi au danger (suppression) — cohérent avec « action vitale ».
...
| `heart` | `#FF6B8B → #F43F5E` | Danger, cardio |
