 ...
 * to not call it.
 *
 * The transparent bar colours already come from `Theme.Elan` (theme
 ...
 * app's own theme choice rather than the system setting, so a forced light
 * theme on a dark system (or the reverse) still gets readable status and
